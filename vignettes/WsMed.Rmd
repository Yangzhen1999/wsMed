...
The `Moderated Coefficients` table reports the interaction term associated
with each path in `MP`. The `BaseCoef` column links the interaction to the
...
for a one-unit increase in the moderator. Its confidence interval evaluates
