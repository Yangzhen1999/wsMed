...
vignette: >
  %\VignetteIndexEntry{GenerateModelCP}
...
<p align="center">
  <img src="CP.png" alt="serial + parallel mediation model" width="100%">
</p>
...
2. **Chained Path Effects:**
   For paths from the chained mediator through the parallel mediators:
   \[
