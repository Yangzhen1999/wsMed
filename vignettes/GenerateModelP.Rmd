...
<p align="center">
  <img src="P.png" alt="Parallel within-subject mediation model" width="100%">
</p>
...
To compute pre- and post-measurement coefficients \( X1_{b,i} \) and \( X0_{b,i} \), consider two mediators \( M_1 \) and \( M_2 \):
...
### 5.2 Post-Measurement Coefficients

The post-measurement coefficient \( X1_{b,i} \) is defined as:
\[
X1_{b,i} = b + d
\]
...
### 5.3 Pre-Measurement Coefficients

The pre-measurement coefficient \( X0_{b,i} \) is defined as:
\[
X0_{b,i} = X1_{b,i} - d
\]
...
This section summarizes all the regression equations used in the analysis, including the difference model, indirect effects, mediator comparisons, and pre- and post-measurement coefficients.
...
3. Pre- and post-measurement coefficients quantify the effects in specific conditions.
