...
<p align="center">
  <img src="CN.png" alt="serial within-subject mediation model" width="100%">
</p>
---
...
For pre- and post-measurement conditions, the coefficients are calculated as follows:
...
1. **Post-Measurement Coefficient (\( X1_{b,ij} \)):**
   \[
   X1_{b,ij} = b_{ij} + d_{ij}
   \]

2. **Pre-Measurement Coefficient (\( X0_{b,ij} \)):**
   \[
...
For three mediators \( M_1, M_2, M_3 \), the coefficients are calculated as follows:
   ...
   - Post-Measurement Coefficient:
     \[
     X1_{b,1} = b_1 + d_1
     \]
   - Pre-Measurement Coefficient:
     \[
     X0_{b,1} = X1_{b,1} - d_1
     \]
